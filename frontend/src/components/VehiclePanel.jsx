    ...
    return (
        <div>
            ...
            <div
                ...
                className={`flex items-center rounded-2xl p-2 mb-2 justify-between cursor-pointer border-2 transition-all ${selectedVehicle === 'ubergo'
            ...
            >
                ...
                <div className='w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>
                        {fare?.distanceText ? `${fare.distanceText} away` : '2 mins away'}
                    </h5>
            ...
            <div
                ...
                className={`flex items-center rounded-2xl p-2 mb-2 justify-between cursor-pointer border-2 transition-all ${selectedVehicle === 'moto'
                        ? 'border-black bg-gray-100'
                        : 'border-gray-200'
                    }`}
            >
                ...
                <div className='w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>
                        {fare?.distanceText ? `${fare.distanceText} away` : '3 mins away'}
                    </h5>
            ...
            <div
                ...
                className={`flex items-center rounded-2xl p-2 mb-1 justify-between cursor-pointer border-2 transition-all ${selectedVehicle === 'auto'
                        ? 'border-black bg-gray-100'
                        : 'border-gray-200'
                    }`}
            >
